...
```{r}
problem3 <- plot(svd.out$u[,1], svd.out$u[,2], pch=4, xlab="Left singular vector 1", ylab="Left singular vector 2", main="Top 2 Left Singular Vectors")
...
problem4 <- ggplot(data, aes(x = Vector, y = Value)) +
...
PCA has a long history in multivariate analysis. Combined with that of eigen decomposition, singular value decomposition, and related methods, there are confusing terminologies. If you are to use the PCA functions in R, you may get different results.
